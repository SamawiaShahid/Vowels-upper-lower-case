...
if(caseLower === 'a' || caseLower === 'e'  || caseLower === 'i'  || caseLower === 'o'  || caseLower === 'u'){
    console.log(chalk.yellow(`"You entered the character '${caseLower}', which is a Vowel.`) );
}else {
    console.log(chalk.green(`You entered the character '${caseLower}', which is a Consonant.`) );
}